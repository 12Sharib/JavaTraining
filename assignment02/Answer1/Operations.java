...
public class Operations {
	List findVersionAndServer(List list,String value) {
	...
	void printOperation(List list,String value,String maxServer,String minServer,Double maxVersion,Double minVersion) {
		Integer temp=0;
