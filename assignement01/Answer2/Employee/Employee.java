package assignement01.Answer2.Employee;
...
public class Employee implements Comparable<Employee>{
	...
	public Employee(Integer empId, String empName, String empEmail, Character empGender, Float empSalary) {
		this.empId = empId;
	...
	public boolean addEmployee(Integer empId,String empName, String empEmail, Character empGender,Float empSalary) {
	...
	public boolean showSlip(Integer id) {
		Iterator<Employee> it = newEmp.iterator();
		while(it.hasNext()) {
			Employee emp = it.next();
